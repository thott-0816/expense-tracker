  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-zinc-200 bg-white px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="overflow-x-auto">
        ...
        {nearbyPages[0] !== 1 ? (
          <button
            className="h-9 min-w-9 cursor-pointer rounded-full border border-zinc-300 px-3 text-sm font-medium text-zinc-700"
          ...
          <button
            ...
            className={`h-9 min-w-9 rounded-full px-3 text-sm font-medium ${
              page === currentPage
                ...
                : "cursor-pointer border border-zinc-300 text-zinc-700"
            }`}
            key={page}
